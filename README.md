...
[Read the documentation here. 📖](https://catterwaul.github.io/And/documentation/and/) 

## Dependency 

And is in the "Major Version Zero" phase, allowing for rapid development based on community feedback. 
